...
scheme_base="fg=$onedark_black, bg=$onedark_visual_grey, nobold"
scheme_current="fg=$onedark_black, bg=$onedark_visual_grey"

scheme_activity="fg=$onedark_black, bg=$onedark_yellow"
...
set "window-status-current-format" "#[fg=$onedark_black,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[$scheme_base] #I  #W"
